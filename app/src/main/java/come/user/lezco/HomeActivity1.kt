...
import come.user.lezco.gpsLocation.AutoCompleteAdapter
...
class HomeActivity1 : FragmentActivity(), OnMapReadyCallback,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userPref = PreferenceManager.getDefaultSharedPreferences(this@HomeActivity1)
        ...
        ProgressDialog = Dialog(this@HomeActivity1, android.R.style.Theme_Translucent_NoTitleBar)
...
//        edt_write_comment!!.typeface = Roboto_Regular
        ...
        pickupDragLayoutManager = LinearLayoutManager(this@HomeActivity1)
        ...
        gpsTracker = GPSTracker(this@HomeActivity1)

        if (PickupLongtude != 0.0 && PickupLatitude != 0.0) {
            bothLocationString = "pickeup"
            if (Common.isNetworkAvailable(this@HomeActivity1)) {
                ...
                Toast.makeText(this@HomeActivity1, "No Network", Toast.LENGTH_LONG).show()
            }
        } else {
        ...
        common.SlideMenuDesign(slidingMenu, this@HomeActivity1, "home")
        ...
        NowDialog = Dialog(this@HomeActivity1, R.style.DialogUpDownAnim)
        ...
        layout_book.setOnClickListener(View.OnClickListener {
            if (edt_pickup_location!!.text.toString().trim { it <= ' ' }.length == 0) {
                Common.showMkError(this@HomeActivity1, resources.getString(R.string.enter_pickup))
                return@OnClickListener
            } else if (edt_drop_location!!.text.toString().trim { it <= ' ' }.length == 0) {
                Common.showMkError(this@HomeActivity1, resources.getString(R.string.enter_drop))
                return@OnClickListener
            }
            ...
            if (totlePrice != 0f) {
                val bi = Intent(this@HomeActivity1, TripDetailActivity::class.java)
                bi.putExtra(
                    "pickup_point",
...
//                bi.putExtra("comment", edt_write_comment!!.text.toString().trim { it <= ' ' })
        ...
        if (CabDetailAry != null && CabDetailAry.length() > 0) {
            ...
            if (cabDetailArray != null && cabDetailArray!!.size > 0) {
                ...
                cabDetailAdapter = CabDetailAdapter(this@HomeActivity1, cabDetailArray!!)
                recycle_cab_detail.adapter = cabDetailAdapter
                cabDetailAdapter!!.setOnCabDetailItemClickListener(this@HomeActivity1)
...
//                        sheetBehavior.peekHeight = 500
        ...
        layout_footer!!.setOnClickListener(View.OnClickListener {
            ...
            if (edt_pickup_location!!.text.toString().isEmpty()) {
                ...
                Common.showMkError(this@HomeActivity1, resources.getString(R.string.location_long))
                return@OnClickListener
            } else if (distance == 0.0f) {
                Common.showMkError(this@HomeActivity1, resources.getString(R.string.location_short))
                return@OnClickListener
            }
...
//            NowDialog!!.show()
        ...
        /*Cash Dialog Strat*/
        CashDialog = Dialog(this@HomeActivity1, R.style.DialogUpDownAnim)
        ...
        layout_cash_credit_card.setOnClickListener {
            PaymentType = "Stripe"
            val si = Intent(this@HomeActivity1, StripeFormActivity::class.java)
        ...
        ReservationDialog = Dialog(this@HomeActivity1, R.style.DialogUpDownAnim)
        ...
        layout_done.setOnClickListener(View.OnClickListener {
            ...
            if (afterOneMonth) {
                Common.showMkError(this@HomeActivity1, resources.getString(R.string.time_is_large))
                return@OnClickListener
            } else if (!dateVal) {
                Common.showMkError(
                    this@HomeActivity1,
...
//        }
    ...
    fun onBuyPressed() {
        ...
        val intent = Intent(this@HomeActivity1, PaymentActivity::class.java)
                ...
                if (clickText == "pickeup") {
                    if (edt_pickup_location!!.text.toString().length > 0) {
                        ...
                        if (Common.isNetworkAvailable(this@HomeActivity1)) {
                            ...
                            Toast.makeText(this@HomeActivity1, "No Network", Toast.LENGTH_LONG)
                                .show()
                        }
                    }
...
//                            }
                    ...
                    Common.ShowHttpErrorMessage(this@HomeActivity1, error.message)
                }
            }
...
//        MarkerAdd()
    ...
    inner class CaculationDiration : AsyncTask<String, Int, String>() {
        ...
        override fun onPostExecute(result: String) {
            val isStatus = Common.ShowHttpErrorMessage(this@HomeActivity1, result)
            if (isStatus) {
                try {
        ...
        override fun handleMessage(message: Message) {
            ...
            if (locationAddress != null) {
                if (locationAddress == "Unable connect to Geocoder") {
                    Toast.makeText(this@HomeActivity1, "No Network conection", Toast.LENGTH_LONG)
                        .show()
                } else {
            ...
            if (locationAddress != null) {
                if (locationAddress == "Unable connect to Geocoder") {
                    ...
                    if (edt_drop_location!!.text.length > 0 && edt_pickup_location!!.text.length > 0) {
                        if (checkReady() && Common.isNetworkAvailable(this@HomeActivity1)) {

                            PickupFixRateCall()


                        } else {
                            Common.showInternetInfo(this@HomeActivity1, "")
                        }
                    } else {
                        MarkerAdd()
                    }
    ...
    fun EditorActionListener(locationEditext: EditText, clickText: String) {
        ...
        locationEditext.setOnEditorActionListener { v, actionId, event ->
            ...
            if (event != null && event.keyCode == KeyEvent.KEYCODE_ENTER || actionId == EditorInfo.IME_ACTION_DONE) {
                ...
                if (locationEditext.text.toString().isNotEmpty()) {
                    ...
                    PickupLatitude = 0.0
                    PickupLongtude = 0.0
                    Toast.makeText(this@HomeActivity1, "Please Enter Location", Toast.LENGTH_LONG)
                        .show()
                }
            }
            false
                        ...
                        if (resObj.getString("status").toLowerCase() == "ok") {
                            ...
                            if (locationArray != null && locationArray!!.size > 0) {
                                ...
                                pickupDropLocationAdapter =
                                    PickupDropLocationAdapter(this@HomeActivity1, locationArray!!)
                                recycle_pickup_location.adapter = pickupDropLocationAdapter
                                pickupDropLocationAdapter!!.setOnDropPickupClickListener(this@HomeActivity1)
    ...
    override fun onBackPressed() {
        ...
        if (slidingMenu.isMenuShowing) {
            ...
            AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes) { arg0, arg1 -> super@HomeActivity1.onBackPressed() }
                .create().show()
        }
    }
