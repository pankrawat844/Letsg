...
class AllTripActivity : AppCompatActivity(), AllTripAdapter.OnAllTripClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val layout_user_reject_check = filterDialog.findViewById(R.id.layout_user_reject_check) as RelativeLayout
        ...
        val layout_drv_accept_check = filterDialog.findViewById(R.id.layout_drv_accept_check) as RelativeLayout
    ...
    fun getAllTrip(offset: Int) {
        ...
        Log.d("loadTripsUrl", "loadTripsUrl =" + Url.loadTripsUrl + "=" + userPref.getString("id", "") + "==" + offset.toString())
                    ...
                    if (resObj.getString("status") == "success") {
                        ...
                        if (allTripArray != null && allTripArray!!.size > 0) {
                            if (offset == 0) {
                                ...
                                allTripAdapter = AllTripAdapter(this@AllTripActivity, allTripArray!!)
                        ...
                        val logInt = Intent(this@AllTripActivity, LoginOptionActivity::class.java)
                        ...
                        if (offset == 0) {
                            ...
                            Toast.makeText(this@AllTripActivity, resObj.getString("message").toString(), Toast.LENGTH_LONG).show()
                        }
                    }
    ...
    fun FilterAllTrips(offset: Int, filter: String) {
        ...
        Log.d("loadTripsUrl", "loadTripsUrl FilterString= " + Url.loadTripsFiltersUrl + "==" + FilterString + "==" + userPref.getString("id", "") + "==" + offset.toString())
                ...
                try {
                    ...
                    if (resObj.getString("status") == "success") {
                        ...
                        for (t in 0 until tripArray.length()) {
                            ...
                            allTripFeed.pickupArea = trpObj.getString("pickup_area")
                            allTripFeed.taxiType = trpObj.getString("car_type")
                            allTripFeed.pickupDateTime = trpObj.getString("book_create_date_time")
                            allTripFeed.amount = trpObj.getString("amount")
                            allTripFeed.carIcon = trpObj.getString("icon")
                            allTripFeed.km = trpObj.getString("km")
                            allTripFeed.driverDetail = trpObj.getString("driver_detail")
    ...
    override fun scrollToLoad(position: Int) {
        ...
        if (userPref.getBoolean("setFilter", true) == true && userPref.getString("check all", "") != "check all") {
            if (userPref.getInt("pending booking", 0) == 1) {
                FilterString += 1.toString() + ","
            }
            if (userPref.getInt("complete booking", 0) == 9) {
    ...
    override fun tripCancel(position: Int) {
        ...
        val CancelBookingDialog = Dialog(this@AllTripActivity, android.R.style.Theme_Translucent_NoTitleBar)
        ...
        val layout_driver_late = CancelBookingDialog.findViewById(R.id.layout_driver_late) as RelativeLayout
        ...
        val layout_change_mind = CancelBookingDialog.findViewById(R.id.layout_change_mind) as RelativeLayout
        ...
        val layout_another_cab = CancelBookingDialog.findViewById(R.id.layout_another_cab) as RelativeLayout
        ...
        val layout_denied_dute = CancelBookingDialog.findViewById(R.id.layout_denied_dute) as RelativeLayout
        layout_denied_dute.setOnClickListener { CheckBoxCheck("denied_duty") }

        val layout_dont_cancel = CancelBookingDialog.findViewById(R.id.layout_dont_cancel) as RelativeLayout
        layout_dont_cancel.setOnClickListener { CancelBookingDialog.cancel() }

        val layout_cancel_ride = CancelBookingDialog.findViewById(R.id.layout_cancel_ride) as RelativeLayout
        layout_cancel_ride.setOnClickListener {
            ...
            Log.d("deleteCabUrl", "deleteCabUrl = " + Url.deleteCabUrl + "?" + SelTripFeeds.bookingId + "==" + userPref.getString("id", ""))
            Ion.with(this@AllTripActivity)
                    .load(Url.deleteCabUrl + "?booking_id=" + SelTripFeeds.bookingId + "&uid=" + userPref.getString("id", ""))
                    .setTimeout(6000)
                    //.setJsonObjectBody(json)
                ...
                if (error == null) {
                    try {
                        ...
                        if (resObj.getString("status") == "success") {
                            ...
                            Handler().postDelayed({
                                val homeInt = Intent(this@AllTripActivity, HomeActivity::class.java)
    ...
    override fun onBackPressed() {
        ...
        if (slidingMenu.isMenuShowing) {
            ...
            AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(android.R.string.yes) { arg0, arg1 -> super@AllTripActivity.onBackPressed() }.create().show()
        }
    }
}
