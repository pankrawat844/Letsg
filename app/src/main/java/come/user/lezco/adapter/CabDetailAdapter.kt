 ...
 */
class CabDetailAdapter(
    internal var activity: Activity,
    internal var cabDetailsArrayList: ArrayList<CabDetails>
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val view =
            LayoutInflater.from(activity).inflate(R.layout.cabdetail_list_layout, parent, false)
    ...
    private fun bindCabDetailFeedItem(position: Int, holder: CabDetailViewHolder) {
        ...
        if (cabDetails.icon != "") {
            ...
            Glide.with(activity)
                .load(iconUri)
                .placeholder(R.drawable.jeep)
                .into(holder.img_car_icon)

        } else {
            Glide.with(activity)
                .load(R.drawable.jeep)
                .placeholder(R.drawable.jeep)
                .into(holder.img_car_icon)
        }
    ...
    fun firstItemSelected() {
        if (onCabDetailClickListener != null)
            onCabDetailClickListener!!.CarDetailTab(0)
    }
    ...
    inner class CabDetailViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        var img_selected_indicator: View
        var img_car_icon: ImageView
        var img_fix_rate_icon: ImageView
        var txt_car_type: TextView
        var layout_tab: RelativeLayout

        init {

            img_selected_indicator = view.findViewById(R.id.img_selected_indicator)
