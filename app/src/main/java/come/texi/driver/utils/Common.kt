...
class Common {
    ...
    class LoginSocialUserHttp(internal var SocialUrl: String, internal var facebook_id: String, internal var twitter_id: String, internal var activity: Activity) : AsyncTask<String, Int, String>() {
    ...
    class LoginCallHttp(internal var activity: Activity, internal var ProgressDialog: Dialog?, internal var cusRotateLoading: RotateLoading?, internal var password: String, internal var activityName: String, internal var LoginUrl: String) : AsyncTask<String, Int, String>() {
        private var content: String? = null
        internal var userPref: SharedPreferences
        internal var PickupLongtude: Double = 0.toDouble()
        internal var PickupLatitude: Double = 0.toDouble()
    ...
    fun SlideMenuDesign(slidingMenu: SlidingMenu, activity: Activity, clickMenu: String) {
        ...
        val Roboto_Regular = Typeface.createFromAsset(activity.assets, "fonts/OpenSans-Regular_0.ttf")
        ...
        layout_cahnge_password = slidingMenu.findViewById(R.id.layout_cahnge_password) as RelativeLayout
    ...
    class CallUnSubscribeTaken(internal var activity: Activity, internal var DeviceToken: String) : AsyncTask<String, Void, String>() {
    ...
    class CallDeviceTaken(activity: Activity, internal var DeviceToken: String) : AsyncTask<String, Void, String>() {
    ...
    companion object {
        ...
        fun showLoginRegisterMkError(act: Activity, message: String) {
            if (!act.isFinishing) {
                ...
                slideUpAnimation = AnimationUtils.loadAnimation(act.applicationContext,
                        R.anim.slide_up_map)

                val layout_info_panel = MKInfoPanelDialog.findViewById(R.id.layout_info_panel) as RelativeLayout
        ...
        fun LoginMkError(act: Activity, message: String, code: String) {
            ...
            val OpenSans_Regular = Typeface.createFromAsset(act.assets, "fonts/OpenSans-Regular_0.ttf")
            ...
            val txt_invalid_login = LoginErrorDialog.findViewById(R.id.txt_invalid_login) as TextView
            val txt_error_msg = LoginErrorDialog.findViewById(R.id.txt_error_msg) as TextView
            Log.d("code", "code = $code")
            if (code.toLowerCase() == "invalid login") {
                ...
                txt_invalid_login.text = act.resources.getString(R.string.recheck_your_login_detail_title)
        ...
        fun showMkError(act: Activity, error_code: String) {
            ...
            if (!act.isFinishing) {
                ...
                val buttonLayoutParams = RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, act.resources.getDimension(R.dimen.height_40).toInt())
                buttonLayoutParams.setMargins(0, act.resources.getDimension(R.dimen.height_50).toInt(), 0, 0)
        ...
        fun showMkSucess(act: Activity, message: String, isHeader: String) {
            if (!act.isFinishing) {
                ...
                if (isHeader == "yes") {
                    val buttonLayoutParams = RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, act.resources.getDimension(R.dimen.height_50).toInt())
                    buttonLayoutParams.setMargins(0, act.resources.getDimension(R.dimen.height_50).toInt(), 0, 0)
                    layout_info_panel.layoutParams = buttonLayoutParams
                }
        ...
        fun getTotalPrice(intailrate: String, FirstKm: Float, distance: Float?, fromintailrate: String, ride_time_rate: String, totalTime: Int): Float {
        ...
        fun ValidationGone(activity: Activity, rlMainView: RelativeLayout, edt_reg_username: EditText) {
